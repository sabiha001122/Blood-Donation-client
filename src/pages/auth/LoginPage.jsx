  ...
  return (
    <div className="flex items-center justify-center py-12">
      <div className="w-full max-w-md bg-white rounded-2xl shadow-lg border border-slate-200 p-8">
        ...
        <p className="text-sm text-slate-600 mb-6">Login to manage donors and donations.</p>
        ...
        <p className="text-sm text-slate-600 mt-6">
          Need an account?{" "}
          <Link className="text-red-600 hover:text-red-700 font-semibold" to="/register">
            Register
          </Link>
        </p>
      </div>
